namespace StillLife3x3COOK {
    ...
    operation Main() : Result[] {
        ...
        for i in 0..4 {
            PerformGroversAlgorithmStep(grid, tempWork, nextGrid, phaseInverter, ancillia);
        }
    ...
    operation PerformGroversAlgorithmStep(grid : Qubit[], tempWork : Qubit[], nextGrid : Qubit[], phaseInverter : Qubit, ancillia : Qubit[]) : Unit {
